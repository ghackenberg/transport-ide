...
\abstract{As transportation systems have to become more intelligent, efficient and, ultimately, sustainable, the complexity of designing these systems has increased fundamentally.
	...
	Designing efficient transportation systems is a difficult undertaking due to the vast size of the solution space and the emergent dynamics of the system components, which have to be considered. Therefore, transportation system engineers need appropriate tools and methods to wholistically explore the design space and test solutions quickly and reliably. In this paper, we propose a simulation-based environment using discrete event simulation (DES) for transportation system design, which is based on a formal system theory. For this, we describe the necessary static properties, dynamic state functions, constraints as well as events describing the design space of our simulation environment in the scope of mobility-on-demand problems.}
...
%TODO Merge Structure and Contribution
...
%TODO state, dynamic, action, constraints? 
...
\noindent
%TODO demand is assigned to vehicle
% TODO Rework
