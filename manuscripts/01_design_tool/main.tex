...
To compare control strategies, we apply the strategies to the same system configuration (including driving and charging infrastructure as well as vehicle fleets) and scenario (i.e.\ demands).
